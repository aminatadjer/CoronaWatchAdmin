...
validateClick(id){
  console.log(id)
  axios.put(apiConfig.apiUrl_cas_signales + `${id}/CasSignalerValider/`,{
    "valide":1,
    "vu":1,
  }).then(res=>{
...
deleteClick(id){
  console.log(id)
  axios.put(apiConfig.apiUrl_cas_signales + `${id}/CasSignalerSupprimer/`,{
    "supprime":1,
    "vu":1,
  }).then(res=>{
    this.componentDidMount();
...
;
 ...
 List(file_extention) {
  ...
  componentDidMount(){
    ...
    axios.get(apiConfig.apiUrl_cas_signales
    ).then(res =>{
        console.log(res);
